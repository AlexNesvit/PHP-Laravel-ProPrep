...
<head>
    ...
    <!-- Inclusion des polices et du CSS -->
    <link rel="preconnect" href="https://fonts.bunny.net">
    <link href="https://fonts.bunny.net/css?family=figtree:400,500,600&display=swap" rel="stylesheet" />
    @if (file_exists(public_path('build/manifest.json')) || file_exists(public_path('hot')))
        <!-- Utilisation de Vite pour gérer les assets si le fichier manifest ou hot existe -->
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                ...
                <div class="g-white dark:bg-gray-800 text-white text-center py-4">
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                ...
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    ...
                    <!-- Section de navigation avec vérification de l'authentification -->
                    @if (Route::has('login'))
    ...
    <footer class="footer py-6 text-center text-sm text-gray-500">
        {{ __('messages.thank_you') }} | <a href="https://www.buymeacoffee.com/alexnesvit" target="_blank"
            class="underline">{{ __('messages.support_project') }}</a>
    </footer>
</body>
